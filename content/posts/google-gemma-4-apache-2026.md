---
title: "Google Drops Gemma 4 Under Apache 2.0 в— Now Runs on a Raspberry Pi"
date: "2026-04-02"
excerpt: "Google releases Gemma 4 в— a family of AI models under Apache 2.0. 31B model, MoE architecture, edge models on 1.5GB RAM."
...
- **Gemma 4 31B** в— dense model, ranked #3 on open leaderboards
- **Gemma 4 26B-A4B** в— Google's first mixture-of-experts: 128 experts, only 3.8B active parameters
- **Gemma 4 E4B and E2B** в— phones, Raspberry Pi, Jetson Nano. E2B runs under 1.5GB RAM
...
The real story isn't "open source" в— it's on-device AI. When a model runs 128K context on a $35 Raspberry Pi, everything changes. Edge computing just got its killer app.
