...
The company announced two new modes for Copilot's Researcher tool—**Critique** and **Council**—that put OpenAI's GPT and Anthropic's Claude to work on the same research task. The result, according to Microsoft's testing, scores higher than every standalone system on the [DRACO benchmark](https://arxiv.org/abs/2602.11685), a standardized test covering 100 complex research tasks across medicine, law, and technology.
