---
title: "Brain-Inspired Chip Promises 2000x AI Energy Efficiency Breakthrough"
date: "2026-04-04"
...
youtubeId: "khEBQiXChYA"
source: "https://decrypt.co/363164/ai-could-become-2000-times-more-efficient-by-copying-the-brain-study"
coverImage: "/covers/brain-inspired-ai-chip-2000x-efficient-2026.jpg"
author: "SiliconFeed"
---

## The Hardware Revolution

AI has an energy problem. Every query to ChatGPT or Claude shuttles data between memory and processor, burning power with every transfer. A team at Loughborough University just designed a chip that eliminates that bottleneck вЂ” and cut energy consumption by up to 2,000 times.

The key is radical simplicity: process data where it lives, instead of bouncing it around like a courier service.

## How It Works

The chip uses a **memory resistor** вЂ” a component that remembers past signals and changes how it responds to new ones. This mirrors the human brain, where neurons form seemingly random connections that evolve with experience.
...
> вЂ” Dr. Pavel Borisov, lead author
