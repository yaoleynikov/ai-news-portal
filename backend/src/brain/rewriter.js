...
16. primary_rubric: exactly one string — **"ai"** (ML, agents, models, search, avatars), **"hardware"** (chips, devices, GPUs, phones), **"open-source"** (licenses, Linux, community projects, Git), **"security"** (cybersecurity, privacy, breaches, malware, infosec), **"energy"** (batteries, EVs, grid, solar/wind, cleantech, climate-related infrastructure), **"business"** (earnings, M&A, funding, layoffs, antitrust, regulation, markets, corporate strategy), **"media"** (streaming, games, film/TV, music/podcasts, creator platforms — product and culture, not quarterly finance), or **"other"** (narrow politics, war, or anything that truly fits none of the above). This drives the site section URL (/rubric/…) for SEO. Prefer **business** over **media** for earnings, subscriber counts as investor metrics, or antitrust suits even if a streamer is named.
